...
#else
#define LOG_VERBOSE(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_FORMAT(LOG_LEVEL_VERBOSE, _LOG_COLOR_V, tag, message), ##__VA_ARGS__);
#endif
#else
...
#if LOG_USE_TIME
#define LOG_DEBUG(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_TIME_FORMAT(LOG_LEVEL_DEBUG, _LOG_COLOR_D, tag, message), ##__VA_ARGS__);
#else
#define LOG_DEBUG(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_FORMAT(LOG_LEVEL_DEBUG, _LOG_COLOR_D, tag, message), ##__VA_ARGS__);
...
#if LOG_USE_TIME
#define LOG_INFO(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_TIME_FORMAT(LOG_LEVEL_INFO, _LOG_COLOR_I, tag, message), ##__VA_ARGS__);
#else
#define LOG_INFO(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_FORMAT(LOG_LEVEL_INFO, _LOG_COLOR_I, tag, message), ##__VA_ARGS__);
...
#if LOG_USE_TIME
#define LOG_WARNING(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_TIME_FORMAT(LOG_LEVEL_WARNING, _LOG_COLOR_W, tag, message), ##__VA_ARGS__);
#else
#define LOG_WARNING(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_FORMAT(LOG_LEVEL_WARNING, _LOG_COLOR_W, tag, message), ##__VA_ARGS__);
#endif
#else
...
#if LOG_USE_TIME
#define LOG_ERROR(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_TIME_FORMAT(LOG_LEVEL_ERROR, _LOG_COLOR_E, tag, message), ##__VA_ARGS__);
#else
#define LOG_ERROR(tag, message, ...) LOG_OUTPUT.printf(_LOG_TAG_FORMAT(LOG_LEVEL_ERROR, _LOG_COLOR_E, tag, message), ##__VA_ARGS__);
#endif
#else
